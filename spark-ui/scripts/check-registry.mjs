 ...
 *
 * 校验 Spark UI 注册表三方一致（project-structure §1）：
...
const schemaPath = join(sparkUiDir, '..', '.harness', 'contracts', 'ui-schema.schema.json');
const core = join(sparkUiDir, 'packages', 'core', 'src');
