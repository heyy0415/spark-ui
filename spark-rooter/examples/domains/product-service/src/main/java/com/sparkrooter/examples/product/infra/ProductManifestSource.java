...
@Component
public class ProductManifestSource implements ToolManifestSource {

  private static final List<String> FILES =
      List.of("product.detail.get.json", "product.list.search.json");

  private final ObjectMapper mapper;

  public ProductManifestSource(ObjectMapper mapper) {
    this.mapper = mapper;
  }
