import { UiComponentSchema, UiSchemaSchema } from '@strato-ui/core';
import { z } from 'zod';

/**
 * 契约投影（真源：.harness/contracts/*.schema.json）。字段名、enum 值、约束逐一对应；ui-schema 的投影真源在 @strato-ui/core（本文件组合引用），
