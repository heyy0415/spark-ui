...
@Component
public class AftersaleManifestSource implements ToolManifestSource {

  private static final List<String> FILES =
      List.of("aftersale.list.get.json", "aftersale.create.json");

  private final ObjectMapper mapper;

  public AftersaleManifestSource(ObjectMapper mapper) {
    this.mapper = mapper;
  }
